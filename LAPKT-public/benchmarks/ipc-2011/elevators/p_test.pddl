...
(reachable-floor fast0 n0)(reachable-floor fast0 n3)(reachable-floor fast0 n6)(reachable-floor fast0 n7)
...
(reachable-floor slow1-0 n6)(reachable-floor slow1-0 n7)

(passenger-at p0 n0)
(passenger-at p1 n0)

(= (travel-slow n0 n1) 6) (= (travel-slow n0 n2) 7) (= (travel-slow n0 n3) 8) (= (travel-slow n0 n4) 9) (= (travel-slow n0 n5) 10) (= (travel-slow n0 n6) 11) (= (travel-slow n1 n2) 6) (= (travel-slow n1 n3) 7) (= (travel-slow n1 n4) 8) (= (travel-slow n1 n5) 9) (= (travel-slow n1 n6) 10) (= (travel-slow n2 n3) 6) (= (travel-slow n2 n4) 7) (= (travel-slow n2 n5) 8) (= (travel-slow n2 n6) 9) (= (travel-slow n3 n4) 6) (= (travel-slow n3 n5) 7) (= (travel-slow n3 n6) 8) (= (travel-slow n4 n5) 6) (= (travel-slow n4 n6) 7) (= (travel-slow n5 n6) 6) (= (travel-slow n6 n7) 6)  

(= (travel-fast n0 n3) 10) (= (travel-fast n0 n6) 19)

(= (travel-fast n3 n6) 10) (= (travel-fast n3 n7) 19)
(= (travel-fast n6 n7) 10) 
